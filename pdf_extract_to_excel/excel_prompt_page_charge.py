...
excel_extraction_page_charge = [extract_actif, extract_bailleur, extract_preneur, extract_taxes_foncieres_locaux_loues, extract_taxes_foncieres_sur_immeubles, extract_TEOM_locaux_loues, extract_Taxes_bureaux_locaux_commerciaux_IDF_locaux_loues, extract_Taxes_bureaux_locaux_commerciaux_IDF_locaux_immeubles, extract_impots_futurs_locaux_loues, extract_honoraires_gestion_locative, extract_honoraires_gestion_loyers, extract_honoraires_gestion_techniques, extract_travaux_code_civil, extract_travaux_conformite, extract_travaux_vetuste, extract_travaux_remplacement]